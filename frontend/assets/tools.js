...
window.VIRTUAL_TOOLS = [
  ...
  {
    slug: "css-cookie-consent",
    name: "CSS Cookie Consent Banner Generator",
    description: "Create CSS cookie consent / GDPR banner components. 4 positions, 3 themes, accept/reject buttons. Copy HTML+CSS.",
    category: "Design",
    icon: "🍪",
  ...
  {
    slug: "css-typing-indicator",
    name: "CSS Typing Indicator Generator",
    description: "Create CSS chat typing indicator dot animations. 5 styles, 3 sizes, custom colors and speed. Copy HTML+CSS.",
    category: "Design",
    icon: "💬",
  ...
  {
    slug: "css-rain",
    name: "CSS Rain Animation Generator",
    description: "Create CSS rain/rainfall animation effects. 4 presets (rain/storm/snow/code-rain), adjustable density/speed. Copy HTML+CSS.",
    category: "Design",
    icon: "🌧️",
  ...
  {
    slug: "css-matrix-rain",
    name: "CSS Matrix Rain Generator",
    description: "Create CSS Matrix digital rain animation. 4 char sets, adjustable columns/speed/color. Copy HTML+CSS.",
    category: "Design",
    icon: "🟢",
